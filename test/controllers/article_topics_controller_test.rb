...
class ArticleTopicsControllerTest < ActionController::TestCase
  ...
  test "should create article_topic" do
    assert_difference('ArticleTopic.count') do
      post :create, article_topic: { description: @article_topic.description, graphic_id: @article_topic.graphic_id, title: @article_topic.title }
    end
  ...
  test "should update article_topic" do
    patch :update, id: @article_topic, article_topic: { description: @article_topic.description, graphic_id: @article_topic.graphic_id, title: @article_topic.title }
    assert_redirected_to article_topic_path(assigns(:article_topic))
  end
