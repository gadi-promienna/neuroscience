...
class GraphicsControllerTest < ActionController::TestCase
  ...
  test "should create graphic" do
    assert_difference('Graphic.count') do
      post :create, graphic: { description: @graphic.description, name: @graphic.name, source: @graphic.source }
    end
  ...
  test "should update graphic" do
    patch :update, id: @graphic, graphic: { description: @graphic.description, name: @graphic.name, source: @graphic.source }
    assert_redirected_to graphic_path(assigns(:graphic))
  end
